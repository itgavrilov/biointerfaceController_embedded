...
//---------------------------------------------------------------------------
// ‘ормат регистра STATUS - Status Control Register 0 (see p30):
//
//     7     6     5     4   |     3     2     1     0
...
//---------------------------------------------------------------------------
// ‘ормат регистра MUX - Input Multiplexer Control Register (see p31):
//
//     7      6      5      4  |     3      2      1      0
...
//---------------------------------------------------------------------------
// ‘ормат регистра ADCON - A/D Control Register (see p31):
//
//     7     6     5   |      4      3   |     2     1     0
...
// ƒл¤ справки: входной динамический диапазон (VIN), при разных настройках коэффициента усилени¤ (PGA)
//  PGA SETTING     VIN SCALE (VREF=2.5V)
//            1     ±5V    (без усилени¤, по умолчанию)
//            2     ±2.5V
//            4     ±1.25V
//            8     ±0.625V
//           16     ±312.5mV
...
//---------------------------------------------------------------------------
// ‘ормат регистра DRATE - A/D Data Rate (see p32):
//
//     7    6    5    4    3    2    1    0
...
//  ¬нутри микросхемы, по сути, реализован делитель тактовой частоты... ѕоэтому, при нестандартной F_CLKIN, Data rates scale linearly with F_CLKIN.
...
//---------------------------------------------------------------------------
// ‘ормат регистра I/O - GPIO Control Register (see p32):
//
//      7     6     5     4  |    3     2     1     0
...
//---------------------------------------------------------------------------
// ‘ормат регистра OFC0 - Offset Calibration Byte 0, least significant byte (see p33):
//
//      7      6      5      4      3      2      1      0
...
// ‘ормат регистра OFC1 - Offset Calibration Byte 1 (see p33):
//
//      7      6      5      4      3      2      1      0
...
// ‘ормат регистра OFC2 - Offset Calibration Byte 2, most significant byte (see p33):
//
//      7      6      5      4      3      2      1      0
...
//---------------------------------------------------------------------------
// ‘ормат регистра FSC0 - Full-scale Calibration Byte 0, least significant byte (see p33):
//
//      7      6      5      4      3      2      1      0
...
// ‘ормат регистра FSC1 - Full-scale Calibration Byte 1 (see p33):
//
//      7      6      5      4      3      2      1      0
...
// ‘ормат регистра FSC2 - Full-scale Calibration Byte 2, most significant byte (see p33):
//
//      7      6      5      4      3      2      1      0
